...
public class Mp4VideoUtil extends com.lh.base.utils.VideoUtil {
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        //ffmpeg的路径
        String ffmpeg_path = "D:\\ffmpeg\\ffmpeg-master-latest-win64-gpl\\bin\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\test412.avi";
        //转换后mp4文件的名称
        String mp4_name = "test413.mp4";
